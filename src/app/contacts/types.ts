export type TimelineItem =
    ...
    | { kind: "call"; id: string; direction: "inbound" | "outbound"; outcome: "connected" | "voicemail" | "no_answer" | "wrong_number"; durationMinutes: number | null; notes: string | null; loggedBy: string | null; createdAt: string };
