...
import { getSpecialAccommodationItems, createSpecialAccommodation, updateSpecialAccommodation, deleteSpecialAccommodation } from "./actions"
...
export function SpecialAccommodationsManager() {
    ...
    const fetchItems = async () => {
        setIsLoading(true)
        const res = await getSpecialAccommodationItems()
