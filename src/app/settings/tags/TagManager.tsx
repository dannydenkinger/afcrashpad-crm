                        ...
                        <div className="flex gap-1">
                            {COLORS.map(c => (
                                <button
                                    ...
                                    className={`w-6 h-6 rounded-full border-2 transition-transform ${newColor === c ? 'scale-110 border-white ring-2 ring-primary' : 'border-transparent opacity-70 hover:opacity-100'}`}
                                    ...
                                    <div className="flex gap-1">
                                        {COLORS.map(c => (
                                            <button
                                                ...
                                                className={`w-5 h-5 rounded-full border-2 ${editColor === c ? 'border-primary scale-110' : 'border-transparent opacity-70'}`}
                                                style={{ backgroundColor: c }}
                                            />
                                        ))}
                                    </div>
